...
class AttackEntryTest {
    ...
    public void test_getters() {
        ActionEntry entry = new AttackEntry("0", "1", 5, "LiLei", "0");
    ...
    public void test_apply() {
        ...
        ActionEntry entry4 = new AttackEntry("0", "3", 3, "LiLei", "2");
        ActionEntry entry5 = new AttackEntry("0", "3", 1, "LiLei", "3");
        ...
        assertEquals(4, terr1.getNumSoldiersInAttacker("LiLei"));
    }
