...
class V2MapViewTest {
  ...
  void test_to_string() throws JsonProcessingException {
    ...
    assertEquals("[{\"name\":\"John\",\"techLevel\":1,\"foodRes\":20,\"techRes\":20,\"isRequested\":false,\"isResCloak\":false,\"shield\":0,\"sword\":0,\"ship\":0,\"missile\":0}]", deView.get("playerInfo").toString());
